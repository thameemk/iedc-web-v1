	...
	<div class="container">
		<div class="section-top-border">
			...
			<div class="col-lg-6 no-padding appoinment-right">
				...
				<form class="appoinment-form" name="memberRegister" action="<?=base_url()?>Register/userRegister" method="post">
					<div class="row">
						...
						<div class="col-lg-12 flex-column">
							<textarea rows="5" class="form-control mt-20" name="whyIedc" placeholder="Why IEDC?" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Why IEDC?'"></textarea>
						</div>
						<br>&nbsp;
						<div class="col-lg-6 d-flex justify-content-end send-btn">
							<button type="submit" class="ui inverted green button">Submit</button>
						</div>
					</div>
				</form>
